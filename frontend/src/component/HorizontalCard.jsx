    ...
    return (
        <div className="horizontal-card">
            ...
            <div className="horizontal-card-detail">
                ...
                <p style={{fontSize: fontSize2 ? `${fontSize2}px` : null}}>Condition: {condition} / 10</p>
                <h3 style={{ fontWeight: 'bold', color: 'var(--primary)', fontSize: fontSize3 ? `${fontSize3}px` : null}}>Looking for <br></br><span style={{ color: 'var(--secondary)' }}>{lookfor}</span></h3>
            </div>
        </div>
    );
}