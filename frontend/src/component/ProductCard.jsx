...
export default function ProductCard(props){
    const {pname, condition, lookfor, imgSize, fontSize1, fontSize2, fontSize3} = props;

    return(
        <div className="card">
            <img src={placeholder} alt="" style={{width: imgSize ? `${imgSize}px` : null, height: imgSize ? `${imgSize}px` : null,}}/>
