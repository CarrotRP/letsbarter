    ...
    return (
        ...
        <footer>
            ...
            <div className="dono-popup" ref={donoBgRef}>
                <div ref={donoRef} style={{userSelect: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    <img src={dono} alt="" />
                    <h2 style={{ color: 'white', fontWeight: 600, fontSize: '32px', textAlign: 'center'}}>{t('thank you')}</h2>
                </div>
            </div>
            <div className="top">
                <div className="logo-desc">
                    ...
                    <span className="find-us" style={{ display: 'flex', alignItems: 'center', marginTop: '20px', gap: '15px', position: 'relative' }}>
                ...
                <div className="dono-link" style={{ position: 'relative' }}>
                    <div className="dono" style={{ position: 'absolute', bottom: '-55px', left: 0, padding: 'inherit', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '5px' }} onClick={handleDonoClick}>
                        ...
                        <h4 style={{ color: 'var(--secondary)' }}>{t('support the site')}</h4>
                    </div>
                </div>
            </div>
