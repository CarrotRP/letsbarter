...
export default function TradeCard(props) {
    const { type, user, itemCount1, itemCount2, decide, tradePopupRef, tradePopupContentRef } = props;
                ...
                <div className="trade-card">
                    ...
                    {decide ? <></> :
                        <span className='decision'>
                            {type == 'incoming' ? <>
                                <p onClick={handleRespondClick} className='respond' style={{ marginRight: '30px' }}>Respond to Offer</p>
